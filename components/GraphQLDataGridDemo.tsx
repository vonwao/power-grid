...
import { EnhancedDataGridGraphQL } from './DataGrid';
import { employees, departments } from './data/mockData';

export default function GraphQLDataGridDemo() {
  /**
   * State Management:
   * - useGraphQL: Controls whether data is fetched using GraphQL or used locally
   *   When true, the GraphQL API is used
